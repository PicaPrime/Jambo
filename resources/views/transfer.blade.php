  ...
  <div class="transfer-dashboard">
    ...
    <div class="transfer-history-section">
      ...
      <div class="transfer-history-table">
        ...
        <!-- Sample Transfer History (Replace with actual data) -->
        <div class="table-row">
          <div class="table-cell">YourUsername</div>
          <div class="table-cell amount-cell amount-negative">-1,000 sats</div>
          <div class="table-cell">PlayerABC</div>
          <div class="table-cell date-cell hide-mobile">2 hours ago</div>
        </div>
        <div class="table-row">
          <div class="table-cell">PlayerXYZ</div>
          <div class="table-cell amount-cell amount-positive">+500 sats</div>
          <div class="table-cell">YourUsername</div>
          <div class="table-cell date-cell hide-mobile">1 day ago</div>
        </div>
        <div class="table-row">
          <div class="table-cell">YourUsername</div>
          <div class="table-cell amount-cell amount-negative">-2,500 sats</div>
          <div class="table-cell">CryptoKing</div>
