  ...
  <div class="modern-profile-header">
    <div class="profile-left">
      ...
      <div class="profile-info">
        <h1 class="modern-username">{{ (
          isset($user) && $user ? $user->name : (Auth::user()->name ?? 'Your Account')
        ) }}</h1>
    ...
    <div class="profile-actions">
      ...
      <div class="joined-date">Joined: {{ isset($joinedDate) && $joinedDate ? $joinedDate : 'N/A' }}</div>
    </div>
  </div>
  <!-- Navigation Tabs -->
    ...
    <div class="stats-column">
        ...
        <div class="balance-card">
          <div class="balance-main">
            <div class="balance-crypto">
              <span class="balance-amount">0.12345678</span>
              <span class="balance-currency">₿</span>
            </div>
            <div class="balance-fiat">≈ $4,567.89 USD</div>
          </div>
      ...
      <div class="stats-section" style="padding-bottom:0px">
        ...
        <div class="deposit-card">
          <div class="qr-section">
            <div class="qr-code">
              <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh&bgcolor=1a1a1a&color=00ffcc" alt="Bitcoin Deposit QR Code" class="qr-image" />
            </div>
          </div>
          <div class="address-section">
            <div class="address-label">Bitcoin Address (BTC Network)</div>
            <div class="address-container">
              <input type="text" value="bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh" readonly class="address-input" id="depositAddress" />
      ...
      <div class="referral-section">
        ...
        <div class="referral-link-container">
          <input type="text" value="https://hustlebtc.com/r/{{ Auth::user()->name ?? 'YourUsername' }}" readonly class="referral-input" id="referralLink" />
        ...
        <div class="account-stats-grid">
          <div class="account-stat-item">
            ...
            <div class="stat-content">
              <div class="stat-value">2.45678901 ₿</div>
          ...
          <div class="account-stat-item">
            ...
            <div class="stat-content">
              <div class="stat-value">1.23456789 ₿</div>
          ...
          <div class="account-stat-item">
            ...
            <div class="stat-content">
              <div class="stat-value">0.00123456 ₿</div>
          ...
          <div class="account-stat-item highlight">
            ...
            <div class="stat-content">
              <div class="stat-value">+0.98765432 ₿</div>
          ...
          <div class="achievements-grid">
            ...
            <div class="achievement-item earned">
              ...
              <div class="achievement-content">
                ...
                <div class="achievement-desc">Play 100 games</div>
              </div>
            </div>
            <div class="achievement-item earned">
              <div class="achievement-icon">🚀</div>
              <div class="achievement-content">
                ...
                <div class="achievement-desc">Wager over 10 BTC total</div>
              </div>
            </div>
            <div class="achievement-item locked">
              <div class="achievement-icon">👑</div>
              <div class="achievement-content">
                <div class="achievement-title">Millionaire</div>
                <div class="achievement-desc">Win 1 BTC in a single game</div>
              </div>
            </div>
            <div class="achievement-item locked">
              <div class="achievement-icon">🔥</div>
              <div class="achievement-content">
                ...
                <div class="achievement-desc">Win 20 games in a row</div>
              </div>
            </div>
            <div class="achievement-item locked">
              <div class="achievement-icon">💎</div>
              <div class="achievement-content">
                <div class="achievement-title">Diamond Hands</div>
                <div class="achievement-desc">Cash out at 50x multiplier</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="transaction-row">
        <div class="td-type">
          <div class="transaction-type deposit">
            ...
            <span class="type-text">Deposit</span>
          </div>
        </div>
        <div class="td-amount">+0.05000000 ₿</div>
        <div class="td-status">
          <span class="status-badge confirmed">Confirmed</span>
        </div>
        <div class="td-date">2 hours ago</div>
      </div>
      <div class="transaction-row">
        <div class="td-type">
          <div class="transaction-type withdrawal">
            <span class="type-icon">📤</span>
            <span class="type-text">Withdrawal</span>
          </div>
        </div>
        <div class="td-amount">-0.02500000 ₿</div>
        <div class="td-status">
          <span class="status-badge confirmed">Confirmed</span>
        </div>
        <div class="td-date">1 day ago</div>
      </div>
      <div class="transaction-row">
        <div class="td-type">
          <div class="transaction-type faucet">
            <span class="type-icon">🚰</span>
            <span class="type-text">Faucet</span>
          </div>
        </div>
        <div class="td-amount">+0.00001000 ₿</div>
        <div class="td-status">
          <span class="status-badge confirmed">Confirmed</span>
        </div>
        <div class="td-date">3 days ago</div>
      </div>
    </div>
